/* Метрики принадлежат backend; роза показывает отдельное качественное мнение AI. */
...
function renderRadar(prefix, profile) {
  ...
  const svg = svgElement('svg', { viewBox: '0 0 170 150', role: 'img',
    'aria-label': 'Мнение AI: финансы, суды, взыскания, регуляторные риски. Серый означает, что оценки нет.' });
