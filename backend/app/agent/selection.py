...
Пиши коротко и по-русски: не выводи коды LOW/GREEN/CURRENT, называй их смысл словами.
Не перечисляй суммы показателей в мини-сводке: объясни 1–2 обстоятельства для цели.
