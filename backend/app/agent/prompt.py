...
MASTER_PROMPT_VERSION = "master-risk-playbook-0.3.3-shortlist-1"
...
не додумывай. Подборку и таблицу сравнения рисует backend — не пересказывай их
...
нужен ИНН, для сравнения — ИНН двух-трёх компаний. Подборка по критерию ИНН не
