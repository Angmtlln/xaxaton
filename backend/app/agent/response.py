...
GUARD_MESSAGES = {
    ...
    "unknown_conversation": "Сессия истекла или больше недоступна. Запрос не выполнен. История на экране остаётся, но агент больше не имеет её контекста. Укажите ИНН и отправьте запрос заново — начнётся новый диалог.",
}
