...
Актуальный отдельный benchmark для защиты: [DEFENSE.md](DEFENSE.md) — 150
сценариев / 194 реплики, составные вопросы, новые возможности, изолированная
PostgreSQL, оценка обязательных частей текущей моделью проекта. Описанный ниже
банк 406 реплик сохранён как прежний регрессионный набор.
