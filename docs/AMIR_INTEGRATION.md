...
- «Найди компании с выручкой от 10 млн рублей, покажи первые 5» — подборка
  ...
  Поиск по названию компании и всему интернету этим инструментом не реализован.
  Поиск по деятельности добавлен отдельно: [ACTIVITY_SEARCH.md](ACTIVITY_SEARCH.md).
