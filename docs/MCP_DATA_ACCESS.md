...
семь allowlisted tools; SQL, запись, загрузка файлов и LLM-инструменты не публикуются.
...
идемпотентно применяет 007 и устанавливает пароль; существующие данные не трогает.
