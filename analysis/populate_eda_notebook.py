...
7. Для будущих evals анализировать не «угадал ли агент светофор», а корректно ли он нашёл релевантные raw facts и derived metrics, сослался на evidence и честно обработал missing data.
